...
#define FILTER_FRIENDLY_NAME        L"WifiCapture Monitor 1 LightWeight Filter"
#define FILTER_UNIQUE_NAME          L"{5cbf81c0-5055-47cd-9055-a76b2b4e3697}" //unique name, quid name
#define FILTER_SERVICE_NAME         L"WifiCaptureMonitor"
//
// The filter needs to handle IOCTRLs
//
#define LINKNAME_STRING             L"\\DosDevices\\WIFICAPTURELWF"
#define NTDEVICE_STRING             L"\\Device\\WIFICAPTURELWF"
